...
export abstract class Tutorial {
     ...
     */
    get outro(): string {
        // Support both static string outros and dynamic outros generated by a
        // function, in case the outro needs to reflect something about the
        // particular playthrough.
        if (typeof this._config.outro === "function") {
